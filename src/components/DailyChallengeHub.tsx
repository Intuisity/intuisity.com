...
const styles = StyleSheet.create({
  ...
  headerIcon: { alignItems: "center", borderColor: "rgba(255,255,255,0.55)", borderRadius: 8, borderWidth: 1, height: 38, justifyContent: "center", width: 38 },
  headerEyebrow: { color: "#fff4cf", flex: 1, fontSize: 11, fontWeight: "900", textShadowColor: "rgba(0,0,0,0.35)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3, textTransform: "uppercase" },
  headerTitle: { color: "#f3c64d", fontSize: 22, fontWeight: "900", marginTop: 6, textShadowColor: "rgba(46,18,111,0.55)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  headerTitleCompact: { fontSize: 19, marginTop: 3 },
  headerSubtitle: { color: "#FFFFFF", fontSize: 12, fontWeight: "700", lineHeight: 17, marginTop: 4, maxWidth: 620, textShadowColor: "rgba(0,0,0,0.35)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  ...
  moduleGridItem: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, minHeight: 164, padding: 14, width: "48%" },
  moduleGridItemPressed: { backgroundColor: "#fff4cf", borderColor: "#d79b16", opacity: 0.86, transform: [{ scale: 0.98 }] },
  ...
  homeResultsButton: { alignItems: "center", backgroundColor: "#6537c7", borderColor: "#f3c64d", borderRadius: 8, borderWidth: 2, flexDirection: "row", gap: 10, marginTop: 16, padding: 13 },
  homeResultsIcon: { alignItems: "center", backgroundColor: "#d79b16", borderColor: "#fff4cf", borderRadius: 8, borderWidth: 1, height: 42, justifyContent: "center", width: 42 },
  homeResultsCopy: { flex: 1 },
  homeResultsTitle: { color: "#f3c64d", fontSize: 16, fontWeight: "900" },
  homeResultsText: { color: "#fff4cf", fontSize: 11, lineHeight: 16, marginTop: 2 },
  ...
  secondaryButton: { alignItems: "center", backgroundColor: "#6537c7", borderRadius: 8, justifyContent: "center", marginBottom: 14, minHeight: 48, padding: 12 },
  ...
  resultsPanel: { alignItems: "center", backgroundColor: "#6537c7", borderColor: "#f3c64d", borderRadius: 8, borderWidth: 1, marginBottom: 16, padding: 34 },
  resultsNumber: { color: "#f3c64d", fontSize: 52, fontWeight: "900", marginTop: 10 },
  ...
  lessonCard: { backgroundColor: "#fffaf0", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, marginBottom: 8, paddingHorizontal: 12, paddingTop: 10, paddingBottom: 4 },
  ...
  learningReminder: { backgroundColor: "#fff4cf", borderColor: "#d79b16", borderRadius: 8, borderWidth: 2, marginBottom: 14, padding: 16 },
  ...
  birthdateCard: { backgroundColor: "#fffaf0", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, padding: 18 },
  ...
  birthLocationSuggestions: { backgroundColor: "#FFFBF0", borderColor: "#F3C64D", borderRadius: 9, borderWidth: 1, marginBottom: 9, marginTop: -3, overflow: "hidden" },
  ...
  birthLocationSuggestionText: { color: "#3F1B91", flex: 1, fontSize: 14, fontWeight: "700" },
  birthTimePicker: { alignSelf: "center", backgroundColor: "#fffaf0", borderColor: "#f0dca0", borderRadius: 28, borderWidth: 1, marginBottom: 10, maxWidth: 306, padding: 10, width: "100%" },
  ...
  signSymbol: { alignItems: "center", backgroundColor: "rgba(255, 244, 207, 0.16)", borderRadius: 8, height: 46, justifyContent: "center", width: 46 },
  ...
  astrologyChoicesHeading: { alignItems: "center", backgroundColor: "#fff4cf", borderColor: "#d79b16", borderRadius: 8, borderWidth: 1, flexDirection: "row", gap: 10, marginBottom: 10, padding: 12 },
  ...
  chartSynopsisCard: { backgroundColor: "#fffaf0", borderColor: "#d79b16", borderRadius: 8, borderWidth: 2, marginBottom: 14, padding: 16 },
  ...
  followUpCard: { backgroundColor: "#fff4cf", borderColor: "#d79b16", borderRadius: 8, borderWidth: 1, marginBottom: 14, padding: 16 },
  ...
  opponentToggle: { backgroundColor: "#FFFFFF", borderRadius: 8, flexDirection: "row", gap: 6, marginBottom: 16, padding: 5 },
  ...
  opponentOptionSelected: { backgroundColor: "#6537c7" },
  ...
  treasureModeCard: { alignItems: "flex-start", backgroundColor: "#FFFFFF", borderColor: "#f3c64d", borderRadius: 8, borderWidth: 1, gap: 8, minHeight: 132, padding: 16 },
  ...
  finalScoreNumber: { color: "#fff4cf", fontSize: 48, fontWeight: "900", marginTop: 8 },
  finalScoreLabel: { color: "#fff4cf", fontSize: 16, fontWeight: "800" },
  ...
  finalRawScoreCard: { alignItems: "center", backgroundColor: "rgba(255, 244, 207, 0.16)", borderColor: "rgba(243, 198, 77, 0.62)", borderRadius: 8, borderWidth: 1, marginTop: 12, paddingHorizontal: 18, paddingVertical: 10 },
  finalRawScoreLabel: { color: "#fff4cf", fontSize: 12, fontWeight: "900", textTransform: "uppercase" },
  finalRawScoreValue: { color: "#f3c64d", fontSize: 20, fontWeight: "900", marginTop: 3 },
  finalCreditText: { color: "#fffaf0", fontSize: 12, fontWeight: "800", lineHeight: 17, marginTop: 7, textAlign: "center" },
  resultsSectionTitle: { color: "#30264C", fontSize: 19, fontWeight: "900", marginBottom: 10, marginTop: 4 },
  synopsisCard: { backgroundColor: "#fffaf0", borderColor: "#f3c64d", borderRadius: 8, borderWidth: 1, marginBottom: 10, padding: 14 },
  ...
  scoreBreakdownRow: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", marginBottom: 8, padding: 13 },
  ...
  scoreBreakdownPointsBox: { alignItems: "center", backgroundColor: "#fff4cf", borderColor: "#d79b16", borderRadius: 8, borderWidth: 1, minWidth: 74, paddingHorizontal: 8, paddingVertical: 6 },
  ...
  strengthHero: { alignItems: "center", backgroundColor: "#6537c7", borderRadius: 8, flexDirection: "row", gap: 13, marginBottom: 12, padding: 16 },
  ...
  cumulativeMetric: { alignItems: "center", backgroundColor: "#fffaf0", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, flex: 1, padding: 10 },
  ...
  strengthRow: { backgroundColor: "#FFFFFF", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, marginBottom: 8, padding: 11 },
  ...
  feedbackCard: { backgroundColor: "#FFFFFF", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, marginBottom: 10, padding: 12 },
  ...
  communityMetric: { backgroundColor: "#fffaf0", borderColor: "#f0dca0", borderRadius: 8, borderWidth: 1, minWidth: "47%", padding: 14 },
  communityValue: { color: "#6537c7", fontSize: 22, fontWeight: "900" },
  communityLabel: { color: "#706982", fontSize: 12, fontWeight: "700", marginTop: 4 },
  communityComparison: { backgroundColor: "#fff4cf", borderColor: "#d79b16", borderRadius: 8, borderWidth: 1, marginBottom: 14, padding: 16 },
